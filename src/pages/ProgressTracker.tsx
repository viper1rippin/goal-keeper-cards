...
import { Award, Timer, Target, Flag, LogIn } from "lucide-react";
...
const ProgressTracker = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      // If guest user, set loading to false
      setLoading(false);
    }
  }, [user]);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Create an account to track your focus progress
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-md">
                Sign up to track your focus time, earn badges, and monitor your progress across sessions.
                Guest users can use the timer but won't save any progress.
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {badges.slice(0, 3).map((badge) => (
            <Card key={badge.name} className="border border-slate-800">
