    ...
    <AnimatedContainer className="max-w-7xl mx-auto mb-12">
      <div className="glass-card p-6 rounded-lg border border-slate-800/80 mb-12">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-lg font-medium mb-1">Welcome to Goal Tracker</h2>
            <p className="text-slate-400">Sign in to track your progress and stay focused on your goals.</p>
          </div>
          {onAddGoal && (
            <Button 
              onClick={onAddGoal}
